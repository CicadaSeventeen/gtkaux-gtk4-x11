...
// 		}
		...
		public void set_size_advanced(Gtk.Window window,
			...
			if(helper.is_done()){
				...
				helper.set_info(null,null,width,height,margin_top,margin_right,margin_bottom,margin_left,align_horz,align_vert);
				helper.link_func();
			}
		}
		...
		public void set_position_advanced(Gtk.Window window,
			...
			if(helper.is_done()){
				...
				helper.set_info(x,y,null,null,margin_top,margin_right,margin_bottom,margin_left,align_horz,align_vert);
				helper.link_func();
			}
		}
		...
		public void set_size(Gtk.Window window,
			...
			if(helper.is_done()){
				...
				tmp_width.set_int(width);
				tmp_height.set_int(height);
				helper.set_info(null,null,tmp_width,tmp_height,null,null,null,null,align_horz,align_vert);
				helper.link_func();
			}
		}
		...
		public void set_position(Gtk.Window window,
			...
			if(helper.is_done()){
				...
				tmp_x.set_int(x);
				tmp_y.set_int(y);
				helper.set_info(tmp_x,tmp_y,null,null,null,null,null,null,align_horz,align_vert);
				helper.link_func();
			}
		}
